...
approval decision endpoint, web console submission and tests. It does not yet
replace all public demo seeds or emit workflow signals from approved decisions.
