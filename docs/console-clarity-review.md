...
| Audit | Database engine and replay capability presented as numeric KPIs | Operational event metrics and readable event labels; separate metadata lines; keep raw inspection and replay/export details | Backend implementation is not an operational measurement |
