...
| `infra/helm/limes-axis` | Kubernetes deployment baseline, TLS Ingress routing, external dependency wiring, ExternalSecret synchronization and secret references | TM-006 |
