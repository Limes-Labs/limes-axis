...
| `infra/helm/limes-axis` | Kubernetes deployment baseline, TLS Ingress routing, HPA/PDB availability controls, scheduling/topology controls, external dependency wiring, ExternalSecret synchronization and secret references | TM-006 |
