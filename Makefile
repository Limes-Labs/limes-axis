...
lint:
	pnpm lint
	cd services/api && uv run ruff check --config pyproject.toml . ../../scripts/prepare_oss_export.py ../../scripts/check_architecture_layers.py ../../scripts/check_runtime_dependencies.py
