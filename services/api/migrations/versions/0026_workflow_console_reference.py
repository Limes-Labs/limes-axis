"""workflow console reference record

Revision ID: 0026_workflow_console_reference
Revises: 0025_action_registry_reference
...
revision: str = "0026_workflow_console_reference"
down_revision: str | None = "0025_action_registry_reference"
...
WORKFLOW_CONSOLE_PAYLOAD = {
    ...
    "runtime_notes": [
        "This public workflow console reference record is read-only.",
        ...
        [
            {
                ...
                "source": "bootstrap",
                "version": "2026-06-22",
                "payload": WORKFLOW_CONSOLE_PAYLOAD,
                "created_at": now,
                "updated_at": now,
            }
        ],
