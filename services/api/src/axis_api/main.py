...
from axis_api.routes.models import ModelRouteDependencies, build_model_routers
...
def create_app(
    ...
    *,
    ...
    model_router, model_operations_router = build_model_routers(
        settings=resolved_settings,
        telemetry=telemetry,
        dependencies=ModelRouteDependencies(
            repository=persistence_repository,
            principal=oidc_principal,
            runtime=model_invocation_runtime,
            bind_actor=_bind_body_tenant_actor,
            authorize_model_read=_authorize_model_endpoint_read,
            authorize_tenant_read=_authorize_tenant_read,
            policy_denial_detail=_platform_policy_denied_detail,
        ),
    )
    app.include_router(model_router)
    operations_router.include_router(model_operations_router)
